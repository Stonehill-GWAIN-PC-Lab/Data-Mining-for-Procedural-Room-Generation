...
def buildRelationshipDataFrame(df):
    ...
    row_mask = df["support"] #and df["verts"]=="null" and df["vert centroid x"]=="null" and df["vert centroid y"]=="null" and df["dict obj ref"]=="null" and df["edge 0"]=="null" and df["edge 1"]=="null" and df["edge cost"]=="null"
    print(df["support"]=="null")
